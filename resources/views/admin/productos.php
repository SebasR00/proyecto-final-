...
<body id="page-top">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo '<img class="card-img-top" src="'.$key->url_path.'" alt="Sudadera De Equipo" />' ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php echo '
                                                            <button type="submit" class="btn btn-warning" onclick="editar('.$key->id.')">
                                                                Editar
                                                            </button>'
                                                        ?>
    ...
    <!-- <script src="/assets/sb-admin-2/"></script> -->
