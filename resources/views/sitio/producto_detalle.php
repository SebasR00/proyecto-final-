...
<html lang="en">
    ...
    <body id="page-top" onload="apiTest()">
        ...
        <section class="py-5 mt-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6">
                        <?php echo '<img class="card-img-top mb-5 mb-md-0" src="/'.$producto->url_path.'" alt="Sudadera De Equipo" />' ?>
                    </div>
                    <div class="col-md-6">
                        <div class="small mb-1">(REF)SKU: BST-498</div>
                        ...
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">$<?php echo $producto->precio ?></span>
                            <span id="code">  </span>
                            <span id="money">  </span>
                        </div>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div>
                            <!-- Product image-->
                            <img class="card-img-top" src="../img/conjunto_dama.jpg" alt="Sudadera De Dama" />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
