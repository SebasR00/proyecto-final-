...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/agency/css/deals.css" rel="stylesheet" />
    ...
    <body id="page-top">
        ...
        <section class="page-section container mt-5" >
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$300.000<small class="text-muted fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <img src="assets/agency/img/balon_futbol.jpg" alt="Balon Para Futbol">
                                </ul>
                                <button type="button" class="w-100 btn btn-lg btn-outline-primary">Producto</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$300.000<small class="text-muted fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <img src="assets/agency/img/pesas.jpg" alt="Pesas 5kl" width="225" height="225">
                                </ul>
                                <button type="button" class="w-100 btn btn-lg btn-outline-primary">Producto</button>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$300.000<small class="text-muted fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <img src="assets/agency/img/licra.jpg" alt="Licra Para Dama">
                                </ul>
                                <button type="button" class="w-100 btn btn-lg btn-outline-primary">Producto</button>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$300.000<small class="text-muted fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <img src="assets/agency/img/reloj.jpg" alt="Reloj">
                                </ul>
                                <button type="button" class="w-100 btn btn-lg btn-outline-primary">Producto</button>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$300.000<small class="text-muted fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <img src="assets/agency/img/casco.jpg" alt="Casco De Bicicleta" width="175" height="175">
                                </ul>
                                <button type="button" class="w-100 btn btn-lg btn-outline-primary">Producto</button>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$300.000<small class="text-muted fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <img src="assets/agency/img/maleta.jpg" alt="Maleta Deportiva" width="175" height="175" />
                                </ul>
                                <button type="button" class="w-100 btn btn-lg btn-outline-primary">Producto</button>
                            </div>
                        </div>
